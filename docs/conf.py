...
latex_documents = [
    (master_doc, 'pymemcache.tex', 'pymemcache Documentation',
     'Charles Gordon, Jon Parise, Joe Gordon', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymemcache', 'pymemcache Documentation',
     [author], 1)
]
